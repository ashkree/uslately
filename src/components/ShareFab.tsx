    ...
    <>
      ...
      <div className='fixed bottom-7 right-7 z-40 flex flex-col items-end gap-2.5'>
          ...
          {TYPE_ORDER.map((type, i) => {
            ...
            return (
              ...
              >
                ...
                <span className='flex h-[42px] w-[42px] items-center justify-center rounded-full border border-[#d9b8d3] bg-white/90 text-base text-[#7a5c72]'>
                  {cfg.icon}
                </span>
              </button>
            )
        ...
        <button
          ...
          className={`flex h-[52px] w-[52px] items-center justify-center rounded-full bg-[#b07aa0] text-2xl text-white shadow-[0_4px_20px_rgba(176,122,160,0.4)] transition-all duration-300 hover:bg-[#9c6a8d] ${
